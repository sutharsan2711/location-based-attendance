      ...
      render: (row: Employee) => (
        <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-bold ${
          row.status === 'ACTIVE' 
            ...
            : 'bg-rose-50 dark:bg-rose-950/50 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-800/40'
        }`}>
          {row.status === 'ACTIVE' ? <CheckCircle className="h-3 w-3 shrink-0" /> : <XCircle className="h-3 w-3 shrink-0" />}
          {row.status}
        </span>
      ),
    },
      ...
      render: (row: Employee) => (
        <div className="flex items-center gap-1.5">
          ...
          <Button
            ...
            className="py-1 px-2.5 text-xs font-bold flex items-center gap-1 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 border-indigo-200 dark:border-indigo-800/60 cursor-pointer"
          ...
          <Button
            ...
            className="py-1 px-2.5 text-xs font-bold flex items-center gap-1 bg-emerald-600 hover:bg-emerald-700 shadow-xs cursor-pointer"
          ...
          <Button 
            ...
            title="Edit basic account settings"
            className="p-1.5 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 border-slate-200 dark:border-slate-700 cursor-pointer"
          >
            <Edit2 className="h-3.5 w-3.5 shrink-0 text-slate-600 dark:text-slate-300" />
          </Button>
          ...
          <Button
            ...
            className={`p-1.5 cursor-pointer ${
              row.status === 'ACTIVE' 
                ? 'hover:bg-rose-50 dark:hover:bg-rose-950/40 text-rose-600 dark:text-rose-400 border-rose-200 dark:border-rose-900/60' 
                : 'hover:bg-emerald-50 dark:hover:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-900/60'
            }`}
          ...
          <Button 
            ...
            className="p-1.5 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/40 border-amber-200 dark:border-amber-900/60 cursor-pointer"
          >
          ...
          <Button 
            ...
            className="p-1.5 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/40 border-blue-200 dark:border-blue-900/60 cursor-pointer"
          >
          ...
          <Button
            ...
            className="p-1.5 hover:bg-rose-50 dark:hover:bg-rose-950/40 text-rose-600 dark:text-rose-400 border-rose-200 dark:border-rose-900/60 transition-colors cursor-pointer"
  ...
  const filteredEmployees = useMemo(() => {
    return employees.filter(emp => {
      ...
      if (roleFilter !== 'ALL') {
        ...
        return empRole === roleFilter.toUpperCase();
      }
    ...
    <div className="space-y-6 pb-12 text-slate-800 dark:text-slate-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs transition-colors cursor-pointer"
            title="Refresh Employee List"
          >
            <RefreshCw className="h-4 w-4 shrink-0" />
            <span>Refresh List</span>
          </button>
          <Button variant="primary" size="md" onClick={openAddModal} className="font-bold py-2.5 rounded-xl cursor-pointer">
            <UserPlus className="mr-2 h-4 w-4 shrink-0" /> Add Employee
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
        <div 
          ...
          className={`bg-white dark:bg-slate-800/90 rounded-2xl p-3.5 border transition-all cursor-pointer shadow-xs flex flex-col justify-between ${
            roleFilter === 'ALL' ? 'border-indigo-500 ring-2 ring-indigo-100 dark:ring-indigo-950/60' : 'border-slate-200/80 dark:border-slate-700/60 hover:border-slate-300 dark:hover:border-slate-600'
          }`}
        >
        ...
        <div 
          ...
          className={`bg-white dark:bg-slate-800/90 rounded-2xl p-3.5 border transition-all cursor-pointer shadow-xs flex flex-col justify-between ${
            roleFilter === 'EMPLOYEE' ? 'border-blue-500 ring-2 ring-blue-100 dark:ring-blue-950/60' : 'border-slate-200/80 dark:border-slate-700/60 hover:border-slate-300 dark:hover:border-slate-600'
          }`}
        >
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-black text-blue-700 dark:text-blue-400">{employeesCount}</span>
            <span className="text-[10px] text-blue-600 dark:text-blue-300 font-medium">Full-time</span>
          </div>
        </div>
        ...
        <div 
          ...
          className={`bg-white dark:bg-slate-800/90 rounded-2xl p-3.5 border transition-all cursor-pointer shadow-xs flex flex-col justify-between ${
            roleFilter === 'TRAINEE' ? 'border-purple-500 ring-2 ring-purple-100 dark:ring-purple-950/60' : 'border-slate-200/80 dark:border-slate-700/60 hover:border-slate-300 dark:hover:border-slate-600'
          }`}
        >
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-black text-purple-700 dark:text-purple-400">{traineesCount}</span>
            <span className="text-[10px] text-purple-600 dark:text-purple-300 font-medium">Training</span>
          </div>
        </div>
        ...
        <div 
          ...
          className={`bg-white dark:bg-slate-800/90 rounded-2xl p-3.5 border transition-all cursor-pointer shadow-xs flex flex-col justify-between ${
            roleFilter === 'INTERN' ? 'border-teal-500 ring-2 ring-teal-100 dark:ring-teal-950/60' : 'border-slate-200/80 dark:border-slate-700/60 hover:border-slate-300 dark:hover:border-slate-600'
          }`}
        >
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            <span className="text-[11px] font-bold uppercase tracking-wider">Interns</span>
            <GraduationCap className="h-4 w-4 text-teal-600 dark:text-teal-400 shrink-0" />
          </div>
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-black text-teal-700 dark:text-teal-400">{internsCount}</span>
            <span className="text-[10px] text-teal-600 dark:text-teal-300 font-medium">Internship</span>
          </div>
        </div>
        ...
        <div 
          ...
          className={`bg-white dark:bg-slate-800/90 rounded-2xl p-3.5 border transition-all cursor-pointer shadow-xs flex flex-col justify-between ${
            roleFilter === 'OJT' ? 'border-amber-500 ring-2 ring-amber-100 dark:ring-amber-950/60' : 'border-slate-200/80 dark:border-slate-700/60 hover:border-slate-300 dark:hover:border-slate-600'
          }`}
        >
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-black text-amber-700 dark:text-amber-400">{ojtCount}</span>
            <span className="text-[10px] text-amber-600 dark:text-amber-300 font-medium">On-the-Job</span>
          </div>
        </div>
        ...
        <div 
          ...
          className={`bg-white dark:bg-slate-800/90 rounded-2xl p-3.5 border transition-all cursor-pointer shadow-xs flex flex-col justify-between ${
            roleFilter === 'ADMIN' ? 'border-indigo-500 ring-2 ring-indigo-100 dark:ring-indigo-950/60' : 'border-slate-200/80 dark:border-slate-700/60 hover:border-slate-300 dark:hover:border-slate-600'
          }`}
        >
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-black text-indigo-700 dark:text-indigo-400">{adminCount}</span>
            <span className="text-[10px] text-indigo-600 dark:text-indigo-300 font-medium">Management</span>
          </div>
        </div>
      </div>

      {/* ── Toolbar & Filters ── */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-200/90 dark:border-slate-800 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative flex-1 w-full">
          <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-400 dark:text-slate-500 shrink-0" />
          <input
            type="text"
            placeholder="Search by code, name, email, department..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full pl-9 pr-4 py-2 text-xs font-semibold bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-750 focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>
          ...
          <div className="relative" ref={columnDropdownRef}>
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border text-xs font-bold transition-all cursor-pointer ${
                showColumnDropdown
                  ? 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border-indigo-300 dark:border-indigo-700 ring-2 ring-indigo-100 dark:ring-indigo-950'
