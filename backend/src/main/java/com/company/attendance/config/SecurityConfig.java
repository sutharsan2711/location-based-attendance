    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/employees/*").hasAnyRole("ADMIN", "EMPLOYEE", "TRAINEE", "INTERN")
                .requestMatchers(HttpMethod.POST, "/employees/*/reset-password").hasAnyRole("ADMIN", "EMPLOYEE", "TRAINEE", "INTERN")
                .requestMatchers("/employees/**").hasRole("ADMIN")
                .requestMatchers("/admin/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/location").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/location").hasAnyRole("ADMIN", "EMPLOYEE", "TRAINEE", "INTERN")
                .requestMatchers("/attendance/employee/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/attendance").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/permissions").hasAnyRole("ADMIN", "EMPLOYEE", "TRAINEE", "INTERN")
                .requestMatchers(HttpMethod.GET, "/permissions/my").hasAnyRole("ADMIN", "EMPLOYEE", "TRAINEE", "INTERN")
                .requestMatchers(HttpMethod.POST, "/leaves").hasAnyRole("ADMIN", "EMPLOYEE", "TRAINEE", "INTERN")
